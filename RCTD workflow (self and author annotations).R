...
#FDCSP positive epithelial cells weight
Breast_integrated$'FDCSP positive epithelial cell weight self-annotation'=newdata$FDCSP_positive_epithelial_cell_weight
FDCSP_plot<-SpatialFeaturePlot(Breast_integrated,'FDCSP positive epithelial cell weight self-annotation',
                               image.alpha = 0.25,alpha = c(1,20)) &
  theme(text = element_text(face = "bold"),
        legend.text=element_text(size=7.5),
        legend.title=element_text(size=15))
...
#Plasma cell weight
Breast_integrated$'Plasma cell weight self-annotation'=newdata$Plasma_cells_weight
Plasma_plot<-SpatialFeaturePlot(Breast_integrated,'Plasma cell weight self-annotation',
                              image.alpha = 0.25,alpha = c(1,20)) &
  theme(text = element_text(face = "bold"),
        legend.text=element_text(size=7.5),
        legend.title=element_text(size=15))
...
#S100A8,KRT17 positive epithelial cell weight
Breast_integrated$'S100A8,KRT17 epithelial cells self-annotation'=newdata$S100A8_KRT17_epithelial_cell_weight
S100A8_plot<-SpatialFeaturePlot(Breast_integrated,"S100A8,KRT17 epithelial cells self-annotation",
                                      image.alpha = 0.25,alpha = c(1,20)) &
  theme(text = element_text(face = "bold"),
        legend.text=element_text(size=7.5),
        legend.title=element_text(size=15))
...
cell_types_author
#Constructing a single-cell reference
reference_author<-Reference(counts_1,cell_types_author)
...
spatialRNA_author<-myRCTD_author@spatialRNA_author
###RCTD results
##Cell contribution of spots mapped onto the original breast tissue biological image. 
#Making a dataframe with cell weights
newbarcode_author<-norm_weights_author@Dimnames[[1]]
nUMIs_author<-norm_weights_author@Dimnames[[1]]
newdata_author <- data.frame(Bcells_weight = norm_weights[,'B-cells'],CAFs_weight = norm_weights[, 'CAFs'],
...
Breast_integrated$'Bcell weight' = newdata_author$Bcells_weight
