...
FeaturePlot(Wu,features = c("KRT15","CRYAB","SAA1","EPCAM"))
VlnPlot(Wu,features = c("KRT15","CRYAB","SAA1","EPCAM"))

#Cluster 8, has shown to express AGR3 and MLPH, exclusively relative to other epithelial clusters
#Largest expression was shown for AGR3 (which is a strong breast cancer marker), thus cluster assigned as 'Cancer epithelial cells'. 
...
#Cluster 13 expresses high levels of S100A8,S100A9,S100A14,S100P and KRT17, exclusively relative to other epithelial clusters. 
#Assigned as 'S100A8,KRT17 positive epithelial cells'.
...
VlnPlot(Wu,features = c("S100A8","S100A9","S100A14","KRT17","EPCAM"))
FeaturePlot(Wu,features = c("S100A8","S100A9","S100A14","KRT17","EPCAM"))
...
VlnPlot(Wu,features = c("FDCSP","EPCAM"))
FeaturePlot(Wu,features=c("FDCSP","EPCAM"))
...
New.cluster.ids1<-c("IL7R rich T-cells","NKG7 rich T-cells","CAFs","FOLR2 negative macrophages",
                    ...
                    "Cycling cells, T-cell rich","S100A8,KRT17 positive epithelial cells","Plasma cells",
