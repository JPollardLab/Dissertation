...
#May point to cluster being of 'fibroblast' identity.
...
VlnPlot(Wu,features = c("CD3D","KLRC2","CD3D","KLRD1","NKG7","GZMB"))
FeaturePlot(Wu,features = c("CD3D","GZMB","KLRC2","CD3D","KLRD1","NKG7"))
...
#Largest expression was shown for AGR3, thus cluster assigned as 'AGR3,MLPH positive epithelial'. 
...
VlnPlot(Wu,features = c("S100A8","KRT17","EPCAM"))
FeaturePlot(Wu,features = c("S100A8","KRT17","EPCAM"))
