...
FeaturePlot(Wu,features = c("GZMB","S100A9","S100A8","KLRC2","CD3D","KLRD1","NKG7"))
...
FeaturePlot(Wu,features = c("AGR3","ANKRD30A","MLPH","ERBB2","MKI67"))
...
#Highest expression is of SCGB1B2P, thus assigned as 'SCGB2B2 positive epithelial'. 
