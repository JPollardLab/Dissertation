...
Wu_ER_synthspot_subset<-subset(Wu_ER_synthspot,subset=celltype_subset %in% c("B cells Memory","CAFs MSC iCAF-like s1","CAFs myCAF like s5",
                                                                             "CAFs Transitioning s3","Cancer Cycling","Cancer LumA SC","Cancer LumB SC",
                                                                             "Endothelial ACKR1","Endothelial CXCL12","Endothelial RGS5","Luminal Progenitors",
                                                                             "Mature Luminal","Myeloid_c1_LAM1_FABP5","Myeloid_c10_Macrophage_1_EGR1",
                                                                             "Myeloid_c11_cDC2_CD1C","Myeloid_c12_Monocyte_1_IL1B","Myeloid_c2_LAM2_APOE",
                                                                             "Myeloid_c4_DCs_pDC_IRF7","Myeloid_c8_Monocyte_2_S100A9","Myoepithelial","Plasmablasts",
                                                                             "PVL Differentiated s3","PVL Immature s1","PVL_Immature s2","T_cells_c0_CD4+_CCR7","T_cells_c1_CD4+_IL7R",
                                                                             "T_cells_c10_NKT_cells_FCGR3A","T_cells_c11_MKI67","T_cells_c2_CD4+_T-regs_FOXP3","T_cells_c3_CD4+_Tfh_CXCL13",
                                                                             "T_cells_c4_CD8+_ZFP36","T_cells_c6_IFIT1","T_cells_c7_CD8+_IFNG","T_cells_c8_CD8+_LAG3","T_cells_c9_NK_cells_AREG"))
...
Wu_TNBC_synthspot_minor<-subset(Wu_TNBC_synthspot,subset = celltype_minor %in% c("B cells Memory","B cells Naive","CAFs MSC iCAF-like",
                                                                                 ...
                                                                                 "Cancer Her2 SC","Cancer LumB SC","Cycling T-cells",
...
Wu_TNBC_synthspot_subset<-subset(Wu_TNBC_synthspot,subset = celltype_subset %in% c("B cells Memory", "B cells Naive","CAFs MSC iCAF-like s1","CAFs MSC iCAF-like s2",
                                                                                   "CAFs myCAF like s4","CAFs myCAF like s5","CAFs Transitioning s3","Cancer Basal SC",
                                                                                   "Cancer Cycling","Cancer Her2 SC","Cancer LumB SC","Cycling_Myeloid","Endothelial ACKR1",
                                                                                   "Endothelial CXCL12","Endothelial RGS5","Luminal Progenitors","Mature Luminal",
                                                                                   "Myeloid_c1_LAM1_FABP5","Myeloid_c10_Macrophage_1_EGR1","Myeloid_c11_cDC2_CD1C",
                                                                                   "Myeloid_c12_Monocyte_1_IL1B","Myeloid_c2_LAM2_APOE","Myeloid_c4_DCs_pDC_IRF7",
                                                                                   "Myeloid_c8_Monocyte_2_S100A9","Myeloid_c9_Macrophage_2_CXCL10","Myoepithelial",
                                                                                   "Plasmablasts","PVL Differentiated s3","PVL Immature s1","PVL_Immature s2",
                                                                                   "T_cells_c0_CD4+_CCR7","T_cells_c1_CD4+_IL7R","T_cells_c10_NKT_cells_FCGR3A",
                                                                                   "T_cells_c11_MKI67","T_cells_c2_CD4+_T-regs_FOXP3","T_cells_c3_CD4+_Tfh_CXCL13",
                                                                                   "T_cells_c4_CD8+_ZFP36","T_cells_c5_CD8+_GZMK","T_cells_c6_IFIT1","T_cells_c7_CD8+_IFNG",
                                                                                   "T_cells_c8_CD8+_LAG3","T_cells_c9_NK_cells_AREG"))
unique(Wu_TNBC_synthspot_subset$celltype_subset)
...
Plot_HER2_major<-Plot_HER2_major %>% 
  ...
  labs(title = "HER2 major cell resolution",x="Cell type major")
Plot_HER2_major
##HER2 minor
...
Plot_HER2_minor<-Plot_HER2_minor %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size = 15,face = "bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "HER2 minor cell resolution",x="Cell type minor")
Plot_HER2_minor
##HER2 subset
...
Plot_HER2_subset<-Plot_HER2_subset %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size = 15,face = "bold")) +
          geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "HER2 subset cell resolution",x="Cell type subset")
Plot_HER2_subset
###ER cancer
##ER major
...
Plot_ER_major<-Plot_ER_major %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size = 15,face = "bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "ER major cell resolution",x="Cell type major")
Plot_ER_major
##ER minor
...
Plot_ER_minor<-Plot_ER_minor %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size = 15,face = "bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "ER minor cell resolution",x="Cell type minor")
Plot_ER_minor
##ER subset
...
Plot_ER_subset<-Plot_ER_subset %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size = 15,face = "bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "ER subset cell resolution",x="Cell type subset")
Plot_ER_subset
###TNBC
##TNBC major
...
Plot_TNBC_major<-Plot_TNBC_major %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size=15,face="bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "TNBC major cell resolution",x="Cell type major")
Plot_TNBC_major
##TNBC minor
...
Plot_TNBC_minor<-Plot_TNBC_minor %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size=15,face="bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "TNBC minor cell resolution",x="Cell type minor")
Plot_TNBC_minor
##TNBC subset
...
Plot_TNBC_subset<-Plot_TNBC_subset %>% 
  ...
  theme(axis.text=element_text(size=12.5),
        ...
        plot.title = element_text(size=15,face="bold")) +
  geom_jitter(color="black", size=0.4, alpha=0.9) +
  labs(title = "TNBC subset cell resolution",x="Cell type subset")
Plot_TNBC_subset
